...
pub struct ArgsAnalyze {
    ...
    #[clap(short('o'), long = "output", value_name = "OUTPUT", help = "Output file path")]
    ...
    #[clap(long = "data-start-time", value_name = "TIME", help = "Data start time in rfc3339 format (e.g., 2025-08-21T00:00:00Z, 2025-08-21T09:00:00+09:00), will ignore update object packets before this time")]
    pub data_start_time: Option<String>,
    #[clap(long = "data-end-time", value_name = "TIME", help = "Data end time in rfc3339 format (e.g., 2025-08-21T00:00:00Z, 2025-08-21T09:00:00+09:00), will ignore update object packets after this time")]
...
pub struct ArgsConvert {
    ...
    pub timeshift: i64,
    #[clap(long = "start-time", value_name = "TIME", help = "Convert start time in rfc3339 format (e.g., 2025-08-21T00:00:00Z, 2025-08-21T09:00:00+09:00), will ignore any packets before this time")]
    pub start_time: Option<String>,
    #[clap(long = "data-start-time", value_name = "TIME", help = "Data start time in rfc3339 format (e.g., 2025-08-21T00:00:00Z, 2025-08-21T09:00:00+09:00), will ignore update object packets before this time")]
    pub data_start_time: Option<String>,
    #[clap(long = "data-end-time", value_name = "TIME", help = "Data end time in rfc3339 format (e.g., 2025-08-21T00:00:00Z, 2025-08-21T09:00:00+09:00), will ignore update object packets after this time")]
    pub data_end_time: Option<String>,
    #[clap(long = "metadata-path", value_name = "PATH", help = "Metadata path in index.md")]
...
async fn main() -> Result<()> {
    ...
    match args.command {
        Some(Commands::Download(ref download_args)) => {
            ...
            let download_dir = download_args.download_directory.as_deref().unwrap_or("data");
            downloader.download(download_url, Path::new(download_dir)).await?;
        },
            ...
            match analyze_args.analysis_type.as_str() {
                "diff" => {
                    ...
                    let _result = tokio::task::spawn_blocking({
                        ...
                        move || {
                            proto_diff::diff_standard_files(&file1_path, &file2_path, Some(analyze_args.output_path.as_ref()))
                        }
                    }).await??;
                    ...
                    let _result = tokio::task::spawn_blocking({
                        ...
                        move || {
                            match analysis_type.as_str() {
                                "standard" => {
                                    proto::analyze_binary_file_with_output_and_count(&file_path, Some(&output_path), packet_count, analyze_args.file_count_limit, analyze_args.file_size_limit, analyze_args.data_start_time.clone(), analyze_args.data_end_time.clone())
                                }
                                "mixed" => {
                                    proto::analyze_mixed_binary_file_with_output_and_count(&file_path, Some(&output_path), packet_count, analyze_args.file_count_limit, analyze_args.file_size_limit, analyze_args.data_start_time.clone(), analyze_args.data_end_time.clone())
                                }
                                _ => {
        ...
        Some(Commands::Convert(convert_args)) => {
            ...
            let _result = tokio::task::spawn_blocking({
                ...
                move || {
                    ...
                    converter.convert_mixed_to_standard(&input_file, &output_dir, convert_args.timeshift, convert_args.split, convert_args.start_time, convert_args.data_start_time, convert_args.data_end_time, convert_args.metadata_path)
                }
            }).await??;
