...
impl<'a> MissionApi<'a> {
    ...
    define_post_method!(
        ...
        crate::model::BeginnerMissionGetListRequest
    );
    ...
    define_post_method!(
        mission_get_list,
        "/mission/get_list",
        crate::model::MissionGetListRequest
    );
    ...
    define_post_method!(
        ...
        crate::model::MissionReceiveCommonMissionRewardRequest
    );
    ...
    define_post_method!(
        ...
        crate::model::StepUpBeginnerMissionGetListRequest
    );
